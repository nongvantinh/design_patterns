#ifndef GUMBALL_MACHINE_STATE_WINNER_H
#define GUMBALL_MACHINE_STATE_WINNER_H
...
namespace gumball_machine_state_winner
{
	...
	public:
		...
		std::shared_ptr<State> get_winner_state();
		String to_string();
	...
	private:
		...
		std::shared_ptr<State> m_winner_state;
	...
	{
	public:
		WinnerState(GumballMachine &p_gumball_machine);
...
#endif // !GUMBALL_MACHINE_STATE_WINNER_H